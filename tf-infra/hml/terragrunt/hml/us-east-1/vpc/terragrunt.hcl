...
inputs = {
  vpc_cidr_block = "10.86.59.0/24"
  public_subnet1_cidr_block = "10.86.59.128/27"
  public_subnet2_cidr_block = "10.86.59.160/27"
  private_subnet1_cidr_block = "10.86.59.0/26"
  private_subnet2_cidr_block = "10.86.59.64/26"
  ...
  tags = {
    ...
    servico         = "VPC"
    "kubernetes.io/cluster/hml-globo" = "shared"
  }
}
