...
inputs = {
  ...
  cluster_addons = {
    ...
    aws-ebs-csi-driver = {
      resolve_conflicts = "OVERWRITE"
      service_account_role_arn = "arn:aws:iam::${local.account_vars.locals.aws_account_id}:role/ebs-csi-prd-globo"
    }
  }

  vpc_id            = "vpc-07ceeb96265c778d7"
  ...
  subnets           = ["subnet-00ade3a6457ac0873", "subnet-0fe74d05513b9357f"] #redes privadas
